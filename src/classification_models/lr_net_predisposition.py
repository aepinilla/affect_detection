...
def lr_net_predisposition():
    ...
    means_std.to_csv(d + '/reports/metrics/lr_net_predisposition_means.csv', index=True)

    print('Metrics for the net predisposition LR model were exported to /reports/metrics/')
